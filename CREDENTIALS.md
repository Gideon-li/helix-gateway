...
登录页 **不能自行注册**，也没有 Google / X。账号由超级管理员或管理员开通。

| 邮箱 | 角色 | 密码 |
| --- | --- | --- |
| `524347725@qq.com` | 超级管理员 | `Helix#524347725` |
| `divination558@foxmail.com` | 管理员 | `destiny1986` |

登录页不展示这些信息。进入后可在 **账号** 页开通其他人、改权限、停用、设置密码。超级管理员不能被停用或改角色。

找回密码的邮件从 `524347725@qq.com` 发出（SMTP 授权码已配置）。
